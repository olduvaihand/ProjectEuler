/*
 * ProjectEuler/src/c/Problem119.c
 *
 * Digit power sum
 * ===============
 * Published on Friday, 7th April 2006, 06:00 pm
 *
 ...
 * digits to have a sum. You are given that a2 = 512 and a10 = 614656. Find a30.
 */
 
#include <stdio.h>
#include "ProjectEuler/ProjectEuler.h"
#include "ProjectEuler/Problem119.h"
