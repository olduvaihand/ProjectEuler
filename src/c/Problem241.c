/*
 * ProjectEuler/src/c/Problem241.c
 *
 * Perfection Quotients
 * ====================
 * Published on Saturday, 18th April 2009, 02:00 am
 *
 ...
 * integer asp(n)=  σ(n)n .      Find the sum of all positive integers n  1018
 * for which p(n) has the form k + 1⁄2, where k is an integer.
 */
 
#include <stdio.h>
#include "ProjectEuler/ProjectEuler.h"
#include "ProjectEuler/Problem241.h"
