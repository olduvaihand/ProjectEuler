/*
 * ProjectEuler/src/c/Problem161.c
 *
 * Triominoes
 * ==========
 * Published on Friday, 21st September 2007, 06:00 pm
 *
 ...
 * reflection or rotation from another tiling as different there are 41 ways a 2
 * by 9 grid can be  tiled with triominoes:  In how many ways can a 9 by 12 grid
 * be tiled in this way by triominoes?
 */
 
#include <stdio.h>
#include "ProjectEuler/ProjectEuler.h"
#include "ProjectEuler/Problem161.h"
