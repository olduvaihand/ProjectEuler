/*
 * ProjectEuler/src/c/Problem346.c
 *
 * Strong Repunits
 * ===============
 ...
 * two bases b > 1.      We shall call a positive integer with this property a
 * strong repunit. It can be verified that there are 8 strong repunits below 50:
 * {1,7,13,15,21,31,40,43}. Furthermore, the sum of all strong repunits below
 * 1000 equals 15864.    Find the sum of all strong repunits below 1012.
 */
 
#include <stdio.h>
#include "ProjectEuler/ProjectEuler.h"
#include "ProjectEuler/Problem346.h"
