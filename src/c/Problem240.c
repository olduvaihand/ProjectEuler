/*
 * ProjectEuler/src/c/Problem240.c
 *
 * Top Dice
 * ========
 * Published on Friday, 10th April 2009, 10:00 pm
 *
 ...
 * 12-sided dice (sides numbered 1 to 12) be rolled so that the top ten sum to
 * 70?
 */
 
#include <stdio.h>
#include "ProjectEuler/ProjectEuler.h"
#include "ProjectEuler/Problem240.h"
