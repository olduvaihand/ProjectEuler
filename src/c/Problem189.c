/*
 * ProjectEuler/src/c/Problem189.c
 *
 * Tri-colouring a triangular grid
 * ===============================
 * Published on Friday, 11th April 2008, 05:00 pm
 *
 ...
 * is considered distinct from C unless the two are identical. How many distinct
 * valid colourings are there for the above configuration?
 */
 
#include <stdio.h>
#include "ProjectEuler/ProjectEuler.h"
#include "ProjectEuler/Problem189.h"
