/*
 * ProjectEuler/src/c/Problem420.c
 *
 * 2x2 positive integer matrix
 * ===========================
 * Published on Sunday, 24th March 2013, 01:00 am
 *
 ...
 * positive integer matrix in two different ways. Here is an example:      We
 * define F(N) as the number of the 2x2 positive integer matrices which have a
...
#include "ProjectEuler/Problem420.h"
