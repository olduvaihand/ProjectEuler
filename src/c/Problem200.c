/*
 * ProjectEuler/src/c/Problem200.c
 *
 * Find the 200th prime-proof sqube containing the contiguous sub-string "200"
 * ===========================================================================
 * Published on Saturday, 28th June 2008, 10:00 am
 *
 ...
 * first number for which you cannot change any single digit to make a prime; we
 * shall call such numbers, prime-proof. The next prime-proof sqube which
...
#include "ProjectEuler/Problem200.h"
