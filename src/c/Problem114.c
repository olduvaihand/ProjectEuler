/*
 * ProjectEuler/src/c/Problem114.c
 *
 * Counting block combinations I
 * =============================
 * Published on Friday, 17th February 2006, 06:00 pm
 *
 ...
 * Although the example above does not lend itself to the possibility, in
...
#include "ProjectEuler/Problem114.h"
