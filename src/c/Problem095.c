/*
 * ProjectEuler/src/c/Problem095.c
 *
 * Amicable chains
 * ===============
 * Published on Friday, 13th May 2005, 06:00 pm
 *
 ...
 * numbers: 12496  14288  15472  14536  14264 ( 12496  ...) Since this chain
 * returns to its starting point, it is called an amicable chain. Find the
 * smallest member of the longest amicable chain with no element exceeding one
 * million.
 */
 
#include <stdio.h>
#include "ProjectEuler/ProjectEuler.h"
#include "ProjectEuler/Problem095.h"
