# -*- coding: utf-8 -*-
# ProjectEuler/src/python/problem247.py
#
# Squares under a hyperbola
# =========================
# Published on Friday, 29th May 2009, 09:00 pm
#
...
# number of squares below Sn.       The diagram shows some such squares
# labelled by number.   S2 has one square to its left and none below, so the
# index of S2 is (1,0).  It can be seen that the index of S32 is (1,1) as is
# the index of S50.   50 is the largest n for which the index of Sn is (1,1).
