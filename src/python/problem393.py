# -*- coding: utf-8 -*-
# ProjectEuler/src/python/problem393.py
#
# Migrating ants
# ==============
# Published on Saturday, 8th September 2012, 05:00 pm
#
# An  nn grid of squares contains  n2 ants, one ant per square.  All ants
# decide to move simultaneously to an adjacent square (usually 4 possibilities,
