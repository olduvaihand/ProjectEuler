#ifndef __PROJECT_EULER_PROBLEM055_H__
#define __PROJECT_EULER_PROBLEM055_H__
/*
 * ProjectEuler/include/c/ProjectEuler/Problem055.h
 *
 * Lychrel numbers
 * ===============
 * Published on Friday, 24th October 2003, 06:00 pm
 *
 ...
 * + 2921 = 4213  4213 + 3124 = 7337 That is, 349 took three iterations to
 * arrive at a palindrome. Although no one has proved it yet, it is thought that
 * some numbers, like 196, never produce a palindrome. A number that never forms
 ...
 * example is 4994. How many Lychrel numbers are there below ten-thousand? NOTE:
 * Wording was modified slightly on 24 April 2007 to emphasise the theoretical
...
#endif  /* __PROJECT_EULER_PROBLEM055_H__ */
