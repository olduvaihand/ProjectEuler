#ifndef __PROJECT_EULER_PROBLEM265_H__
#define __PROJECT_EULER_PROBLEM265_H__
/*
 * ProjectEuler/include/c/ProjectEuler/Problem265.h
 *
 * Binary Circles
 * ==============
 * Published on Saturday, 21st November 2009, 09:00 am
 *
 ...
 * thus represented as 23 and 29:  00010111 2 = 23 00011101 2 = 29 Calling S(N)
 * the sum of the unique numeric representations, we can see that S(3) = 23 + 29
 * = 52. Find S(5).
 */
...
#endif  /* __PROJECT_EULER_PROBLEM265_H__ */
