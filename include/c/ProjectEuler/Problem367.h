#ifndef __PROJECT_EULER_PROBLEM367_H__
#define __PROJECT_EULER_PROBLEM367_H__
/*
 * ProjectEuler/include/c/ProjectEuler/Problem367.h
 *
 * bozo sort
 * =========
 * Published on Saturday, 14th January 2012, 10:00 pm
 *
 ...
 * randomly two elements. This is repeated until eventually the sequence is
 * sorted.     If we consider all permutations of the first 4 natural numbers as
 * input the expectation value of the number of swaps, averaged over all 4!
 * input sequences is 24.75.  The already sorted sequence takes 0 steps.      In
 * this problem we consider the following variant on bozo sort.  If the sequence
 ...
 * the number of shuffles, averaged over all 4! input sequences is 27.5.
 ...
 * shuffles this sorting algorithm will perform?     Give your answer rounded to
 * the nearest integer.
 */
...
#endif  /* __PROJECT_EULER_PROBLEM367_H__ */
