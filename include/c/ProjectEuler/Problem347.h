#ifndef __PROJECT_EULER_PROBLEM347_H__
#define __PROJECT_EULER_PROBLEM347_H__
/*
 * ProjectEuler/include/c/ProjectEuler/Problem347.h
 *
 ...
 * such a positive integer does not exist.     E.g. M(2,3,100)=96.
 ...
 * divisible by both 2 and 73.     Let S(N) be the sum of all distinct M(p,q,N).
 * S(100)=2262.     Find S(10 000 000).
 */
...
#endif  /* __PROJECT_EULER_PROBLEM347_H__ */
