#ifndef __PROJECT_EULER_PROBLEM270_H__
#define __PROJECT_EULER_PROBLEM270_H__
/*
 * ProjectEuler/include/c/ProjectEuler/Problem270.h
 *
 * Cutting Squares
 * ===============
 * Published on Saturday, 26th December 2009, 01:00 am
 *
 ...
 * respecting the following rules:   We only make straight cuts between two
 ...
 * an NN square. For example, C(1) = 2 and C(2) = 30 (shown below).  What is
 * C(30) mod 108 ?
 */
...
#endif  /* __PROJECT_EULER_PROBLEM270_H__ */
