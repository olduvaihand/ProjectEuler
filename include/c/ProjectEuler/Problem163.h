#ifndef __PROJECT_EULER_PROBLEM163_H__
#define __PROJECT_EULER_PROBLEM163_H__
/*
 * ProjectEuler/include/c/ProjectEuler/Problem163.h
 *
 * Cross-hatched triangles
 * =======================
 * Published on Saturday, 13th October 2007, 02:00 am
 *
 ...
 * size 2 triangle in the above sketch. One-hundred and four triangles of either
 * different shape or size or orientation or location can now be observed in
 * that size 2 triangle. It can be observed that the size 2 triangle contains 4
 * size 1 triangle building blocks. A size 3 triangle would contain 9 size 1
 * triangle building blocks and a size n triangle would thus contain n2 size 1
...
#endif  /* __PROJECT_EULER_PROBLEM163_H__ */
