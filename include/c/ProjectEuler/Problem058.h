#ifndef __PROJECT_EULER_PROBLEM058_H__
#define __PROJECT_EULER_PROBLEM058_H__
/*
 * ProjectEuler/include/c/ProjectEuler/Problem058.h
 *
 * Spiral primes
 * =============
 * Published on Friday, 5th December 2003, 06:00 pm
 *
 * Starting with 1 and spiralling anticlockwise in the following way, a square
 * spiral with side length 7 is formed. 37 36 35 34 33 32 31  38 17 16 15 14 13
 * 30  39 18  5  4  3 12 29  40 19  6  1  2 11 28  41 20  7  8  9 10 27  42 21
 * 22 23 24 25 26 43 44 45 46 47 48 49 It is interesting to note that the odd
...
#endif  /* __PROJECT_EULER_PROBLEM058_H__ */
