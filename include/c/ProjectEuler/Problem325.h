#ifndef __PROJECT_EULER_PROBLEM325_H__
#define __PROJECT_EULER_PROBLEM325_H__
/*
 * ProjectEuler/include/c/ProjectEuler/Problem325.h
 *
 * Stone Game II
 * =============
 * Published on Saturday, 19th February 2011, 01:00 pm
 *
 ...
 * (xi+yi) for all losing configurations (xi,yi), 0  xi  yi  N. We can verify
 * that S(10) = 211 and S(104) = 230312207313.     Find S(1016) mod 710.
 */
...
#endif  /* __PROJECT_EULER_PROBLEM325_H__ */
